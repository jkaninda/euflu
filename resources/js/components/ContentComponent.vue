<template>
  ...
  <div class="main-content wf100"> 
    ...
    <!--Team Squad Start-->
    <section class="team-squad wf100 p80-50" hidden>
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="awards">
              ...
              <div id="awards-slider" class="owl-carousel owl-theme">
                <div class="item"> <img src="images/award1.png" alt="">
                  <h5> Champion FIFA <strong>2010</strong> </h5>
                </div>
                <div class="item"> <img src="images/award2.png" alt="">
                  <h5> Champion du Congo <strong>2012</strong> </h5>
                </div>
                <div class="item"> <img src="images/award3.png" alt="">
                  <h5> Champion FIFA <strong>2014</strong> </h5>
                </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <button class="button" data-filter=".f1">Photographie</button>
