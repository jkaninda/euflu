...
<!--Header End--> 
    ...
    <div class="home2-slider rev_slider_wrapper"> 
      ...
      <div class="rev_slider_wrapper fullwidthbanner-container">
        <div id="rev-slider2" class="rev_slider fullwidthabanner">
          <ul>
            <li data-transition="fade"> <img src="images/slide1-bg.jpg"  alt="" width="1920" height="750" data-bgposition="top center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="1" >
            ...
            <li data-transition="fade"> <img src="images/slide3bg.jpg"  alt="" width="1920" height="750" data-bgposition="top center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="1" >
              <div class="tp-caption  tp-resizeme" 
                              data-x="right" data-hoffset="350" 
                              data-y="top" data-voffset="0" 
                              data-transform_idle="o:1;"         
                              ...
                              data-splitout="none"
                              data-start="700">
                <div class="slide-content-box"> <img src="images/slide3player.png" alt=""> </div>
              </div>
              <div class="tp-caption  tp-resizeme" 
                              data-x="left" data-hoffset="400" 
                              data-y="top" data-voffset="205" 
  ...
  <div class="main-content wf100"> 
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="section-title white">
              ...
              <a class="full-team" href="index.html#">Full Team Squad</a> </div>
          </div>
        </div>
        <div class="row"> 
          <!--Player Box Start-->
          <div class="col-md-6">
            <div class="player-box">
              ...
              <div class="player-txt"> <span class="star-tag"><i class="fas fa-star"></i></span>
                ...
                <a class="playerbio" href="index.html#">Player Biography <i class="far fa-arrow-alt-circle-right"></i></a> <a href="index.html#" class="follow">Follow</a> </div>
            </div>
          </div>
          <!--Player Box End--> 
          <!--Player Box Start-->
          <div class="col-md-6">
            <div class="player-box">
              <div class="player-thumb"><img src="images/player2.png" alt=""></div>
              <div class="player-txt"> <span class="star-tag"><i class="fas fa-star"></i></span>
                <h3>Jaun Carry</h3>
          ...
          <div class="col-md-6">
            <div class="player-box">
              <div class="player-thumb"><img src="images/player3.png" alt=""></div>
              <div class="player-txt"> <span class="star-tag"><i class="fas fa-star"></i></span>
                <h3>Jaun Carry</h3>
                <strong class="player-desi">Goal Keeper</strong>
                <p> Hi, I am Jaun Carry the team captain of the soccer club.</p>
          ...
          <div class="col-md-6">
            <div class="player-box">
              <div class="player-thumb"><img src="images/player4.png" alt=""></div>
              <div class="player-txt"> <span class="star-tag"><i class="fas fa-star"></i></span>
                <h3>Geryson Ramsy</h3>
                <strong class="player-desi">League Captain</strong>
                <p> Hi, I am Gerrysson Ramsy the team captain of the soccer club. </p>
      ...
      <div class="container">
        ...
        <div class="row"> 
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="pro-box">
              <div class="pro-thumb"> <a href="index.html#"><i class="fas fa-link"></i></a> <img src="images/pro1.jpg" alt=""> </div>
              <div class="pro-txt">
                <h4> <a href="index.html#">Sports Team T-Shirt</a> </h4>
                <p class="price"> <del>£20.00</del> <strong>£17.50</strong> </p>
                <a href="index.html#" class="add2cart">Add to Cart</a> </div>
            </div>
          </div>
          <!--Product End--> 
          <!--Product Start-->
          <div class="col-lg-3 col-sm-6">
            <div class="pro-box">
              <div class="pro-thumb"> <a href="index.html#"><i class="fas fa-link"></i></a> <img src="images/pro2.jpg" alt=""> </div>
              <div class="pro-txt">
                <h4> <a href="index.html#">Soccer Gloves</a> </h4>
                <p class="price"> <del>£20.00</del> <strong>£17.50</strong> </p>
                <a href="index.html#" class="add2cart">Add to Cart</a> </div>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="pro-box">
              <div class="pro-thumb"> <a href="index.html#"><i class="fas fa-link"></i></a> <img src="images/pro3.jpg" alt=""> </div>
              <div class="pro-txt">
                <h4> <a href="index.html#">Practice T-Shirt</a> </h4>
                <p class="price"> <del>£20.00</del> <strong>£17.50</strong> </p>
                <a href="index.html#" class="add2cart">Add to Cart</a> </div>
            </div>
          </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <a href="index.html#" class="live-show"><i class="fas fa-circle"></i> Live Show</a>
      ...
      <div class="row">
        <div class="col-md-12">
          <ul class="gallery isotope items">
            <li class="item f1">
              <div class="gthumb">
                <div class="hv-info"> <a href="index.html#" class="play"><i class="far fa-image"></i></a>
                  <h6><a href="index.html#">Nicolson Goals are like Storm</a></h6>
                </div>
            ...
            <li class="item f2">
              <div class="gthumb active">
                <div class="hv-info"> <a href="index.html#" class="play"><i class="fas fa-play"></i></a>
                  <h6><a href="index.html#">FC Champs Finished In First Place</a></h6>
                </div>
                <a class="gt-link" href="https://www.youtube.com/watch?v=SLi2gT5H6m8&t=11s" data-rel="prettyPhoto[gallery1]"><i class="fas fa-play"></i></a><img src="images/squadgallery-2.jpg" alt=""></div>
            </li>
            <li class="item f1">
              <div class="gthumb">
                <div class="hv-info"> <a href="index.html#" class="play"><i class="fas fa-search"></i></a>
                  <h6><a href="index.html#">Every Success is a Result of Hard Working</a></h6>
                </div>
            ...
            <li class="item f2">
              <div class="gthumb">
                <div class="hv-info"> <a href="index.html#" class="play"><i class="fas fa-play"></i></a>
                  <h6><a href="index.html#">Be A Game Changer: Tackling blues</a></h6>
                </div>
                <a class="gt-link" href="https://www.youtube.com/watch?v=SLi2gT5H6m8&t=11s" data-rel="prettyPhoto[gallery1]"><i class="fas fa-play"></i></a><img src="images/squadgallery-4.jpg" alt=""></div>
            </li>
          </ul>
        </div>
      </div>
  ...
  <section class="sponsor-logos wf100">
    <div class="container">
      <ul class="row">
        <li class="col-md-2 col-4 col-sm-2"> <a href="index.html#"><img src="images/sitelogos1.png" alt=""></a> </li>
        <li class="col-md-2 col-4 col-sm-2"> <a href="index.html#"><img src="images/sitelogos2.png" alt=""></a> </li>
        <li class="col-md-2 col-4 col-sm-2"> <a href="index.html#"><img src="images/sitelogos3.png" alt=""></a> </li>
        <li class="col-md-2 col-4 col-sm-2"> <a href="index.html#"><img src="images/sitelogos4.png" alt=""></a> </li>
        <li class="col-md-2 col-4 col-sm-2"> <a href="index.html#"><img src="images/sitelogos5.png" alt=""></a> </li>
        <li class="col-md-2 col-4 col-sm-2"> <a href="index.html#"><img src="images/sitelogos6.png" alt=""></a> </li>
      </ul>
    </div>
  </section>
  <!--Sponsor Logos End--> 
  ...
  <section class="tweets-banner wf100">
    <div class="container">
      ...
      <div class="col-md-12"><div class="section-title white">
          ...
          <ul class="row">
            <li class="col-md-4">
              <div class="tweet-box"> <a href="index.html#" class="tshare"><i class="fas fa-share"></i></a>
                <h5>Ben Roots</h5>
            ...
            <li class="col-md-4">
              <div class="tweet-box active"> <a href="index.html#" class="tshare"><i class="fas fa-share"></i></a>
                <h5>Jack Denly</h5>
